...
function InventoryDashboard() {
  ...
  const header = [
    { id: 0, label: "Total Sim", value: 105, color: "#52be2b", background: "#dbf5d2" },
    { id: 1, label: "Total Devices", value: 220, color: "", background: "" },
    { id: 2, label: "Total Sim Assigned Device", value: 200, color: "", background: "" },
    { id: 3, label: "Total Vehcile", value: 150, color: "", background: "" },
    { id: 3, label: "Total Transporter", value: 150, color: "", background: "" },
  ]
    ...
    <Typography>
      Tampering : 02
        ...
        <Paper className={classes.paper} id='left' style={{ width: isopen ? '106%' : '112%', padding: '0.5rem', marginLeft: isopen ? "25px" : "10px" }}>
          ...
          <Grid container xs={10} style={{ display: "inline-flex", marginTop: "6px" }}>
            <Grid xs={4}>

            </Grid>

            <Grid xs={4} style={{ paddingLeft: "20px" }}>
            ...
            <Grid container  xs={12} style={{display:"inline-flex",padding:"20px",marginLeft: "50px", marginTop: "45px",}}>
              {
                header.map((head, index) => (
                  <Grid xs={2} style={{ background: "#f4f4f4", padding: "8px",marginRight:"12px", marginBottom: "16px", border: "1px solid black", borderRadius: "6px" }}>

                    <Typography style={{ fontWeight: "bold", borderRadius: "4px", color: "#000", }}>
